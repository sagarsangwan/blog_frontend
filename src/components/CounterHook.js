...
function CounterHook() {
    ...
    return (
        ...
        //     <button onClick={() => setCount(count + 1)} className='btn btn-primary'>Click me</button>
            ...
            <input className='form-control mt-5 ' value={info.name} onChange={e => setInfo({ name: e.target.value })} />
            <input className='form-control mt-5 ' value={info.email} onChange={e => setInfo({ email: e.target.value })} />
